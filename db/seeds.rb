...
e.ticket_types << TicketType.create(name: '2016 Việt Nam Thử Thách Chiến Thắng dành cho những tay đua đăng kí sớm.', price: 500000, max_quantity: 95, min_in_order: 0, max_in_order: 10, remain: 95)
e.ticket_types << TicketType.create(name: 'Việt Nam Thử Thách Chiến Thắng ( Giá chính thức)', price: 2000000, max_quantity: 5, min_in_order: 0, max_in_order: 10, remain: 5)
...
e.ticket_types << TicketType.create(name: 'Vé loại A', price: 500000, max_quantity: 10, min_in_order: 0, max_in_order: 10, remain: 10)
e.ticket_types << TicketType.create(name: 'Vé loại B', price: 300000, max_quantity: 50, min_in_order: 0, max_in_order: 10, remain: 50)
e.ticket_types << TicketType.create(name: 'Vé loại C', price: 200000, max_quantity: 100, min_in_order: 0, max_in_order: 10, remain: 100)
e.ticket_types << TicketType.create(name: 'Vé loại D', price: 150000, max_quantity: 200, min_in_order: 0, max_in_order: 10, remain: 200)
...
e.ticket_types << TicketType.create(name: 'General', price: 99000, max_quantity: 1000, min_in_order: 0, max_in_order: 10, remain: 1000)
